    ...
    <div className="grid grid-cols-2 gap-8">
      <div className="p-12 border border-border bg-secondary/50 hover:border-primary transition-colors duration-400">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          AI/ML-powered applications, agents, and data-driven business insight products. Ask <span className="text-foreground font-bold">Velocity committee members</span> for guidance.
        </p>
      </div>
      <div className="p-12 border border-border bg-secondary/50 hover:border-primary transition-colors duration-400">
