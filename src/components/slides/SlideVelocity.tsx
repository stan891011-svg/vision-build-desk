...
<SlideWrapper>
    ...
    <p className="text-2xl text-muted-foreground max-w-2xl">LSE's first AI product-building society. Empowering students from any discipline build real products using AI.
    <span className="text-foreground font-bold">any discipline</span> build real products using AI.
    </p>
